<template>
  <div class="content">
    ...
    <div class="input">
		<g-input :label="'账号'" type="text" v-model="username"/>
		<g-input :label="'密码'" type="password" v-model="password"/>
	</div>
    <div class="footbox">
...
<style scoped>
  ...
  .content h1{width:2.18rem;height:1.35rem; background:url(../assets/images/my_cz.png) no-repeat 0 0; background-size:100%; margin:0 auto; margin-top:1.22rem;}
