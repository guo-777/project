<template>
  <div class="detail">
    ...
    <div class="content" v-if="detail.title">
      ...
      <div class="cont">
        <h3>{{detail.title}}</h3>
        <div class="time"><p>{{detail.time | date}} <span><img src="../assets/images/zan.png" alt=""/></span></p></div>
...
<script>
	...
	import UcToolbar from '../components/uc-toolbar/index.vue'
...
<style scoped>
  ...
  .nav{width:100%; position:fixed;top:0;left:0;; border-bottom:1px solid #e8eaec; z-index:99;}
